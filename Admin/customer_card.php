              ...
              <div class="row">
                ...
                <div class=" col-xl-2 col-lg-3  col-md-4 sidebar fixed-top">
                  ...
                  <ul class="navbar-nav flex-column mt-2">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-white p-3 mb-2 current" href="customer.php">
        ...
        <div class="container-fluid">
            <div class="row mb-5">
                <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
                    <div class="row">
                        <div class="col-12">
                        <h3 class="text-muted text-center mb-3">Customer Credit Card Table</h3>
                            ...
                            <div class="card">
                                ...
                                ?>
                                    <div class="table-responsive">
                                        ...
                                        <table class="table" id="card_tbl">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th scope="col">Customer ID</th>
                                                    <th scope="col">Credit Card Holder Name</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['cc_no']; ?></td>
                                                    <td><?php echo $row['cc_ccv']; ?></td>
                                                    <td><?php echo $row['cc_expiry']; ?></td>
                                                </tr>
                                            </tbody>
                                            <?php
                                                    }

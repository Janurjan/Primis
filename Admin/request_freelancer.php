...
<html lang="en">
  <head>
    ...
    <title>Request FreeLancers</title>
    <!-- add icon link -->
        ...
        <div class="container-fluid">
          <div class="row mb-5">
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
              <div class="row">
                <div class="col-12">
                  <h3 class="text-muted text-center mb-3">Freelancer Request Table</h3>
                  ...
                  <div class="card">
                      <div class="card-body">
                        ...
                        <?php
                            $query = "SELECT * FROM  freelancer WHERE fl_status = 'undefined'";
                            $query_run = mysqli_query($conn,$query);
                        ?>
                        <div class="table-responsive">
                            <!-- <form method="post" action=""> -->
                                <table class="table" id="req_freelancer_tbl">
                        ...
                        ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" name="accept" class="btn btn-success acpt_btn1" id="<?php echo $row['fid'];?>">Accept </button>
                                            </td>
                                            <td>

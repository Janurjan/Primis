            ...
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="card">
                    <div class="card-body">
                        <button type="button" class="btn btn-primary"><a href="new_appointment.php" class="text-white" style="text-decoration: none;"> New Appointments </a>
                        </button>
                    </div>
                  </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                         <?php
                             $query = "SELECT * FROM  `appointment` WHERE `status2` = 'finished' and `status` = 'accepted'";

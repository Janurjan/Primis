        ...
        <div class="container-fluid">
          <div class="row mb-5">
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
              <div class="row">
                <div class="col-12">
                  <h3 class="text-muted text-center mb-3">Customer Table</h3>
                  <div class="card">
                    <div class="card-body">
                      <button type="button" class="btn btn-primary"><a href="customer_card.php" class="text-white" style="text-decoration: none;">  View Credit Card Details</a>
                      </button>
                    </div>
                  </div>

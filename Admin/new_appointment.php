            ...
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="card">
                    <div class="card-body">
                        <button type="button" class="btn btn-primary"><a href="old_appointment.php" class="text-white" style="text-decoration: none;"> Old Appointments </a>
                        </button>
                        <!-- <button type="button" class="btn btn-primary"><a href="process_jobs.php" class="text-white" style="text-decoration: none;"> Processing Jobs </a>
                        </button> -->
                    </div>
                  </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                         <?php
                             $query = "SELECT * FROM  `appointment` WHERE `status` = 'not accepted'";
                             $query_run = mysqli_query($conn,$query);
                         ?>
                         <div class="table-responsive">

                              <table class="table" id="newAppointment_tbl">

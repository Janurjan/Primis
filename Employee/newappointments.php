    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Appointments</h5>
            ...
            <form action="" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="7" id="meeting" name="meeting" placeholder="Enter Meeting Details Here!" autocomplete="off" required></textarea>
                    </div>
...
<div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Delete Appointments</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="container-fluid">
          <div class="row mb-5">
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
              <div class="row">
                <div class="col-12">
                  <h3 class="text-muted text-center mb-3">New Appointments Table</h3>
                    <div class="card">
                        <div class="card-body">
                            <button type="button" class="btn btn-primary">
                                <a href="myappointments.php" class="text-white" style="text-decoration: none;">My Appointments</a>
                            </button>
                            <button type="button" class="btn btn-primary">
                  ...
                  <div class="card">
                      <div class="card-body">
                         <?php
                             $query = "SELECT * FROM  `appointment` WHERE `status` = 'not accepted' and `s_name` = '$service'";
                             $query_run = mysqli_query($conn,$query);
                         ?>
                         <div class="table-responsive">

                              <table class="table" id="appointmenttbl">
                                  <thead class="thead-dark">
                                    <tr>
                                      ...
                                      <th scope="col">Meeting Requested Date</th>
                                      <th scope="col" style="width: 10em;">Meeting Details</th>
...
<!---End of section--->
        ...
        if(isset($_POST['updatedata']))
        {
            ...
            $id = $_POST['update_id'];
            $details = $_POST['meeting'];
            $status = $_POST['status'];
        
          $sql = "UPDATE `appointment` SET `details` ='$details', `status`='$status' , `e_name` = '$emp_name', `status2` = 'not started' WHERE appointment_id='$id'  ";
     ...
     $(document).ready(function () {
        $('.editbtn').on('click', function(){
          ...
          $('#editmodal').modal('show');
                ...
                $('#update_cid').val(data[1]);
                $('#cus_name').val(data[2]);
                $('#service_name').val(data[3]);
                $('#purpose').val(data[4]);
                $('#meeting_date').val(data[5]);
                $('#meeting').val(data[6]);
                $('#status').val(data[7]);
        });
   });

  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Delete Old Appointments</h5>
        ...
        <div class="container-fluid">
          <div class="row mb-5">
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
              <div class="row">
                <div class="col-12">
                  <h3 class="text-muted text-center mb-3">Old Appointments Table</h3>
                    <div class="card">
                        <div class="card-body">
                  ...
                  <div class="card">
                      <div class="card-body">
                         <?php
                             $query = "SELECT * FROM  `appointment` WHERE `status2` = 'finished' and `e_name` = '$emp_name'";
                             $query_run = mysqli_query($conn,$query);
                         ?>
                         <div class="table-responsive">

                            <table class="table" id="oldAppointment_tbl">

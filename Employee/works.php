              ...
              <div class="row">
                ...
                <div class=" col-xl-2 col-lg-3  col-md-4 sidebar fixed-top">
                    ...
                    <ul class="navbar-nav flex-column mt-4">
                        ...
                        <li class="nav-item">
                        <a class="nav-link text-white p-3 mb-2 sidebar-link current" href="works.php">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <button type="button" class="btn btn-primary">
                                <a href="oldworks.php" class="text-white" style="text-decoration: none;">Old Works</a>
                            </button>
                        </div>
                    </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                        ...
                        <?php
                            $query = "SELECT * FROM  `job` WHERE `status3` = 'not finished' and `accept_by` = '$emp_name'";

...
<html lang="en">
  <head>
    ...
    <title>Old Works/Employee</title>
    <!-- add icon link -->
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="card">
                        <div class="card-body">
                            <button type="button" class="btn btn-primary">
                                <a href="works.php" class="text-white" style="text-decoration: none;">On Going Works</a>
                            </button>
                        </div>
                    </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                         <?php
                             $query = "SELECT * FROM  job WHERE status3 = 'finished' and accept_by = '$emp_name'";

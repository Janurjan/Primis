...
<html lang="en">
  <head>
    ...
    <title>My Works/Freelancer</title>
    <!-- add icon link -->
              ...
              <div class="row">
                ...
                <div class=" col-xl-2 col-lg-3  col-md-4 sidebar fixed-top">
                    ...
                    <ul class="navbar-nav flex-column mt-4">
                        ...
                        <li class="nav-item">
                        <a class="nav-link text-white p-3 mb-2 sidebar-link current" href="fl_works.php">
        ...
        <div class="container-fluid">
          <div class="row mb-5">
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
              <div class="row">
                <div class="col-12">
                  <h3 class="text-muted text-center mb-3">Works Table</h3>
                    <div class="card">
                        <div class="card-body">
                            <button type="button" class="btn btn-primary">
                                <a href="fl_oldworks.php" class="text-white" style="text-decoration: none;">Old Works</a>
                            </button>
                        </div>
                    </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                        ...
                        <?php
                            $query = "SELECT * FROM  `job` WHERE `status3` = 'not finished' and `accept_by` = '$fl_name'";
                            $query_run = mysqli_query($conn,$query);
                        ?>

                        <div class="table-responsive">
                                <table class="table" id="works_tbl">
                        ...
                        ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" name="accept" class="btn btn-success acpt_btn1"   id="<?php echo $row['job_id'];?>">FINISH </button>
                                            </td>
                                        </tr>
                                    </tbody>
